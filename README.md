...
It is vitally important that you remember to change the inheritance for `FSavedMove_Character` and `FNetworkPredictionData_Client_Character` also at the bottom of the Movement header files! If you experience extreme desync, its because you forgot to do this.
