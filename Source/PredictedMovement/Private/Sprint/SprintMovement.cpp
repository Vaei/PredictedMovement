...
#if WITH_EDITOR
void USprintMovement::PostEditChangeProperty(struct FPropertyChangedEvent& PropertyChangedEvent)
{
...
void USprintMovement::OnRegister()
{
	Super::OnRegister();
...
void USprintMovement::SetMaxInputAngleSprint(float InMaxAngleSprint)
{
